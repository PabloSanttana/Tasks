...
import { Text, StyleSheet, View, TouchableOpacity, Alert, ImageBackground , AsyncStorage} from 'react-native'
...
export default class Auth extends Component {
    ...
    signin = async() => {
        try {
            ...
            // pegando token para usar em todas as requisições automatic
    ...
    render() {
           ...
           // validação para os campos de inpput
           const validations= []
